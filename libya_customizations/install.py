...
def create_roles():
    roles = ["Chief Sales Officer", "Warehouse User", "Sales Coordinator", "Sales Supervisor", "Libya Team", "Accountant", "Chief Executive Officer", "Cash Accountant", "Sales Assistant Manager"]
